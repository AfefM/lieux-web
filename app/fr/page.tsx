...
export default function Page() {
  // Puisque nous sommes dans le dossier /fr, nous forçons la langue
    ...
    <main className="bg-black min-h-screen text-white">
      ...
      <header className="fixed top-0 w-full z-50 p-8 flex justify-between items-center mix-blend-difference">
        ...
        <div className="flex gap-6 text-[10px] tracking-widest uppercase font-black">
           {/* Note: Ces liens devront pointer vers les futurs dossiers /ar et /en si tu les crées */}
           <Link href="#" className="opacity-30 cursor-not-allowed">AR</Link>
           <Link href="/fr" className="underline underline-offset-4">FR</Link>
           <Link href="#" className="opacity-30 cursor-not-allowed">EN</Link>
        </div>
      </header>
          ...
          {lieux.map((lieu, index) => (
            ...
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black via-transparent p-12 flex flex-col justify-end opacity-0 group-hover:opacity-100 transition-opacity">
                <span className="text-[9px] uppercase tracking-widest text-white/50 mb-2">
                  {lieu.category}
                </span>
