...
export default function Page() {
  ...
  if (!lieux || lieux.length === 0) {
    return <div className="bg-black min-h-screen text-white flex items-center justify-center">Chargement...</div>;
  }
      ...
      <section className="relative h-screen w-full flex items-center justify-center overflow-hidden">
        {lieux[0] && (
          <Image 
              ...
              alt="Hero" 
              fill 
              className="object-cover opacity-60 grayscale brightness-75" 
              priority 
          />
        )}
